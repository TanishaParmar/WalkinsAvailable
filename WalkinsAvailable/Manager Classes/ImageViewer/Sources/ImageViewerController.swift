...
UIGestureRecognizerDelegate {
    ...
    init(
        index: Int,
        imageItem:ImageItem, isPresented: Bool = true) {
...
//            imageView.setImage(image: url.absoluteString, placeholder: placeholder, completion: nil)
        default: break
        }
...
//        print("off set ******** \(yOffset)")
        
        print("off set ******** ******  \(xOffset)  ***** \(yOffset)   \nimage frame is \(imageView.frame)")
