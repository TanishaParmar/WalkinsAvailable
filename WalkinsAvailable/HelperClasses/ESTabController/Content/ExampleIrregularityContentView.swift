...
class ExampleIrregularityBasicContentView: ExampleBouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        //UIColor.init(white: 255.0 / 255.0, alpha: 1.0)
        highlightTextColor = .black
        //UIColor.init(red: 23/255.0, green: 149/255.0, blue: 158/255.0, alpha: 1.0)
        iconColor = .black
        //UIColor.init(white: 255.0 / 255.0, alpha: 1.0)
        highlightIconColor = .black
        //UIColor.init(red: 23/255.0, green: 149/255.0, blue: 158/255.0, alpha: 1.0)
        backdropColor = .clear
        //UIColor.init(red: 10/255.0, green: 66/255.0, blue: 91/255.0, alpha: 1.0)
...
//        self.imageView.layer.cornerRadius = 35
        ...
        self.insets = UIEdgeInsets.init(top: -60, left: 0, bottom: 0, right: 0)
