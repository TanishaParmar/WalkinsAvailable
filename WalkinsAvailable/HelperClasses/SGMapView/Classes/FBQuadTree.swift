...
public class FBQuadTree : NSObject {
    ...
    override init (){
        ...
        rootNode = FBQuadTreeNode(boundingBox:FBQuadTreeNode.FBBoundingBoxForMapRect(mapRect: MKMapRect.world))
    ...
    func enumerateAnnotationsUsingBlock(callback: (MKAnnotation) -> Void){
        enumerateAnnotationsInBox(box: FBQuadTreeNode.FBBoundingBoxForMapRect(mapRect: MKMapRect.world), withNode:rootNode!, callback:callback)
    }
